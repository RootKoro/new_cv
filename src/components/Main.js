        ...
        <main className="main-blocks">
            ...
            <section className="main-second-section second-section d-flex">
                <div className="col-2">
                    <h5>Déjà</h5>
                    <h2>1 ans</h2>
                    <h6>d'expérience dans le monde de l'informatique en tant que développeur</h6>
                </div>
                <div className="col-1"></div>
                <div className="col-8">
                    <h5>Développeur Junior à la recherche d'une alternance, spécialisé en développement web, avec des compétences assises en développement desktop</h5>
